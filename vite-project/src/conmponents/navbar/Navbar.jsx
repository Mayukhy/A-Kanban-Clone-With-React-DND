...
export default function Navbar() {
    return (
        <div className="navcontainer">
            <div className="left">
                <Paper sx={{
                    width: { xs: '210px', md: '300px', lg: '417px' },
                    marginTop: { xs: '0px', md: '1px' },
                    border: 'none',
                    boxShadow: 'none'
                }} className='searchbg' >
            ...
            <div className="right">
                ...
                <div className="profilepic">
                    <span className="pic">
                        <Avatar sx={{
                            width: { md: '38px', xs: '30px' },
                            height: { md: '38px', xs: '30px' },
                            marginTop: { xs: '10px', sm: '10px', md: '7px' }
                        }}
                            alt="Remy Sharp" src='/IMGs/Cardsimages/profilepic.png' />
                    </span>
