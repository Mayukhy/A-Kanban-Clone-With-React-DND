          ...
          <span className="users">
            <AvatarGroup >
              <Avatar sx={{
                ...
                height: '38px',
                zIndex: '-1'
              }} alt="Remy Sharp" src="/IMGs/Avatars/Ellipse 12 (2).png" />
              <Avatar
                sx={{
                  width: '38px',
                  height: '38px'
                }} alt="Travis Howard" src="/IMGs/Avatars/Ellipse 13.png" />
              <Avatar
                sx={{
                  width: '38px',
                  height: '38px',
                  zIndex: '1'
                }} alt="Cindy Baker" src="/IMGs/Avatars/Ellipse 14.png" />
              <Avatar
                sx={{
                  width: '38px',
                  height: '38px',
                  zIndex: '2'
                }} alt="Trevor Henderson" src="/IMGs/Avatars/Ellipse 15.png" />
              <span className="twoplus">2+</span>
            </AvatarGroup>
          </span>
        </div>
      </div>
      ...
      <div className="seconddiv">
        <div className="left">
          <span style={{
            ...
            <FormControl sx={{
              ...
              <Select className='dropdownstyle'
                label="Filter" name="Filter" id="" ><MenuItem >
                  <span className="text">Filter</span></MenuItem > </Select>
            </FormControl>
          ...
          <span style={{
            ...
            <FormControl sx={{
              ...
              <Select className='dropdownstyle'
                label="Filter" name="Filter" id="" ><MenuItem >
                  <span className="text">Today</span></MenuItem > </Select>
            </FormControl>
        ...
        <div className="right">
          <span className="share">
            <span className="icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </span><span className="text">Share</span>
          </span>
          <span className="partition"> </span>
          <span className="box"><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
